                ...
                if (dbProduct != null)
                {
                    ...
                    else
                    {
                        foreach (ProductSKUModel productSKU in scproduct.SKUModels)
                        {
                            ...
                            //only requred
                            skuStr.Add("{\"inventory\":" + productSKU.inventory + ",\"price\":" + productSKU.price + ",\"sku_attributes\":{\"Color\":{\"alias\":\"32\",\"sku_image_url\":\"" + StaticValues.sampleImage + "\",\"value\":\"" + color + "\"}},\"sku_code\":\"" + productSKU.skuCode + "\"}");
                            //all
